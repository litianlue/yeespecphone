...
public class ImaPlayer {
    ...
    /**
     * Plays the ad.
     * 使用google-media-framework的SimpleVideoPlayer播放器 ;
     */
     ...
     * 使用google-media-framework的PlaybackControlLayer控制层回调 ;
     */
     ...
     * 使用google-media-framework的ExoplayerWrapper的回调监听器
     */
     ...
     * @param video              The video that should be played. 使用google-media-framework的video来播放服务器上的视频 :
    ...
    private void createAdPlayer() {
        ...
        // TODO: 2016/7/29 : 使用google-media-framework的video来播放服务器上的视频 :
