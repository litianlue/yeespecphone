...
public class MRecyclerviewAdapter extends RecyclerView.Adapter<MRecyclerviewAdapter.MyHolder> {
    ...
    * */
    ...
    public MRecyclerviewAdapter(List<HashMap<String, String>> list) {
        super();
        this.mList = list;
    }
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.mcard_item,
                parent, false);
